Делаю удобное для PHP/JS кодера api на C в kolibrios;


Суть в том, чтобы реализовать:
 1 Самые популярные фнкции PHP (landlib/dummyphpc)
 
 2 API для работы с GUI по образу и подобию https://andryuxa.ru/portfolio/desktop/qt_javascript_desktop/?v=4
   (landlib/desktop/api)


Ниже просто рабочие заметки.
