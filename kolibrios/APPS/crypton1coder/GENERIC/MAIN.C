...
#include "../appcontroller.c" // it functions call landsyscontroller
...
void draw_window()
{
    ...
    _ksys_start_draw();
    _ksys_create_window(15, 100, WIN_W, WIN_H, title, /*0x858585*//*0xEFE9D6*/LLDI_DEFAULT_BG_COLOR, 0x34);//0x13 was 0x34 - fixed
